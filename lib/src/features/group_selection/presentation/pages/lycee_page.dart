...
class LyceePage extends StatefulWidget {
  const LyceePage({super.key});

  @override
  State<LyceePage> createState() => _LyceePageState();
}

class _LyceePageState extends State<LyceePage> {
                ...
                builder: (context, state) {
                  if (state is GroupsLoading) {
                    ...
                    if (lyceeGroups.isEmpty) {
                      return const Center(
                        child: Text('Aucun groupe Lycée trouvé.'),
                      );
                    }

                    return ListView.builder(
                      itemCount: lyceeGroups.length,
                      itemBuilder: (context, index) {
                        final group = lyceeGroups[index];
          ...
          builder: (context, state) {
            if (state is GroupsLoaded) {
              ...
              return FloatingActionButton(
                onPressed: () =>
                    _showAddStudentBottomSheet(context, lyceeGroups),
